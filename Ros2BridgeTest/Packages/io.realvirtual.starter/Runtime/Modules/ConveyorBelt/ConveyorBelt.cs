...
namespace realvirtual
{
    ...
    public class ConveyorBelt : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            {
                // Get the absolute speed and apply direction based on TransportDirection's Z component
                // The belt is oriented along the Z-axis, so we use the sign of the Z component
                float absSpeed = _transportSurface.Drive.IsSpeed / 1000f;
                float directionSign = Mathf.Sign(_transportSurface.TransportDirection.z);
                speed = absSpeed * directionSign;
            }
