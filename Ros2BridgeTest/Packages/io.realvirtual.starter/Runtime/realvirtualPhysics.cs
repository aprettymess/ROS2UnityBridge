...
#endif
    public static class realvirtualPhysics
    {
        public static void Kinematize(GameObject obj)
        {
            ...
            {
                var physicsPath = RealvirtualAssetPaths.StarterPackage + "/Assets/Prefabs/[PhysicsManager].prefab";
                var com = Global.AddComponentTo(null, physicsPath);
                EditorUtility.DisplayDialog("realvirtual Physics manager added",
        ...
        public static void SetPosition(Drive drive, float position)
        {
            ...
            if (drive.IsRotation)
                ...
                currpos = drive.CurrentPosition / drive.realvirtualController.Scale;
