...
namespace realvirtual
{
    ...
    public class Pattern : MonoBehaviour
    {
        ...
        [HideInInspector] public List<GameObject> PatternObjects = new List<GameObject>();
        [Header ("Settings")]
        ...
        public void Delete()
        {
            if (PatternObjects == null) // components serialized before the field initializer existed deserialize to null
            {
