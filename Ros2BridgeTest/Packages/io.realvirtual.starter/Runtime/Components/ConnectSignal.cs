...
namespace realvirtual
{
    ...
    public class ConnectSignal : BehaviorInterface
    {
        ...
        void Start()
        {
            ...
            connectedsignalnotnull = ConnectedSignal != null && thissignal != null;
            if (!connectedsignalnotnull)
            {
                if (ConnectedSignal == null)
                    Logger.Warning("ConnectSignal - no ConnectedSignal assigned, signal will not be copied", this);
                if (thissignal == null)
                    Logger.Warning("ConnectSignal - no Signal component on this GameObject, signal will not be copied", this);
            }
        }
