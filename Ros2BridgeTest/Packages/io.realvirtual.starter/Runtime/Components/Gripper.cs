...
namespace realvirtual
{
    ...
    [HelpURL("https://doc.realvirtual.io/components-and-scripts/picking-and-placing-mus/gripper")]
    [Icon("Packages/io.realvirtual.starter/Editor/EditorAssets/EditorScriptIcons/Gripper Icon.png")]
    #region doc
    ...
    //! https://doc.realvirtual.io/components-and-scripts/picking-and-placing-mus/gripper
    #endregion
    public class Gripper : BehaviorInterface
    {
        ...
        new void Awake()
        {
            ...
            Global.SetLayerSafe(this.gameObject, "rvMU");
            if (nofingers)
            {
