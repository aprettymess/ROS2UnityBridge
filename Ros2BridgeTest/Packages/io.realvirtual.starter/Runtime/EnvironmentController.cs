...
namespace realvirtual
{
    ...
    public class EnvironmentController : MonoBehaviour
    {
        ...
        private void Start()
        {
            // Apply the environment in both edit and play mode. The chain ends in
            // SkyboxSetup.Apply() -> DynamicGI.UpdateEnvironment(), which computes the skybox
            // ambient + reflection live. Running it at runtime too means scenes no longer depend
            // on baked LightingData (which would require a per-scene baked-lighting folder).
            UpdateEnvironment();
