...
#else
        // URP 14 / Unity 2022.3 compatibility (e.g. Tuanjie Editor).
        // The blurred outline effect relies on the RenderGraph API (URP 17 / Unity 6)
        // and is not rendered on the legacy render pipeline.
