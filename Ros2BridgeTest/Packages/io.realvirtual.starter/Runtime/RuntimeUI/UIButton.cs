...
{
#pragma warning disable CS3005 // Base type is not CLS-compliant
    ...
    [HelpURL("https://doc.realvirtual.io/components-and-scripts/scene-interaction/ui-components")]
    [SelectionBase]
    //! Pushbutton that can be connected to a PLCInput
    public class UIButton: realvirtualUI
    {
...
#pragma warning restore CS3005 // Base type is not CLS-compliant