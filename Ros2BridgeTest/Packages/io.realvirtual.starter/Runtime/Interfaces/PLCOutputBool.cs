 ...
 namespace realvirtual
{
	...
	#endregion
	[Icon("Packages/io.realvirtual.starter/Editor/EditorAssets/EditorScriptIcons/PLCOutputBool Icon.png")]
	public class PLCOutputBool : Signal
	{
		...
		{
			Settings.Override = true;
			Status.ValueOverride = (bool)System.Convert.ChangeType(value, typeof(bool));
			if (EventSignalChanged != null) EventSignalChanged.Invoke(this);
			SignalChangedEvent(this);
		}
