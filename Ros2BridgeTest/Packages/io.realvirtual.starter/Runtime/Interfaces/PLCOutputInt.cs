 ...
 namespace realvirtual
{
    ...
    #endregion
    [Icon("Packages/io.realvirtual.starter/Editor/EditorAssets/EditorScriptIcons/PLCOutputInt Icon.png")]
    public class PLCOutputInt : Signal
    {
        ...
        public override void Force(object value)
        {
            ...
            Status.ValueOverride = (int)System.Convert.ChangeType(value, typeof(int));
