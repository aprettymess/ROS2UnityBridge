...
namespace realvirtual
{
    ...
    public class Signal : realvirtualBehavior, IInspector
    {
        ...
        //! Forces the signal to the given value (sets Settings.Override = true and writes the type-specific ValueOverride). Type dispatch is implemented in the derived PLC signal classes.
