...
namespace realvirtual
{
	...
	#endregion
	[Icon("Packages/io.realvirtual.starter/Editor/EditorAssets/EditorScriptIcons/PLCOutputFloat Icon.png")]
	public class PLCOutputFloat : Signal
	{
		...
		//! Forces this signal to the given value (Override on).
		public override void Force(object value)
		{
			Settings.Override = true;
			Status.ValueOverride = (float)System.Convert.ChangeType(value, typeof(float));
			if (EventSignalChanged != null) EventSignalChanged.Invoke(this);
			SignalChangedEvent(this);
		}
