...
namespace realvirtual
{
    ...
    public static class Logger
    {
        ...
        // Managed id of the Unity main thread. Resolving a GameObject hierarchy path
        // touches the Unity API, which is only legal on the main thread. Threaded
        // interfaces log from background threads, so we use this to skip path
        // resolution there instead of throwing a UnityException.
        ...
        private static string GetFullPath(Object context)
        {
            ...
            // Off the main thread we cannot touch the Unity API - skip the path prefix
            // rather than throwing "get_gameObject can only be called from the main thread".
            ...
            {
                // Background thread or destroyed object - skip the path prefix.
            }
