...
// NOTE: This implementation uses reflection and unsupported Unity APIs
// It is disabled for Unity 6+ which has proper EditorToolbar API support
// See QuickEditToolbar.cs for Unity 6+ implementation
...
namespace realvirtual
{
    ...
    public static class QuickEditToolbarIMGUI
    {
        ...
        {
            // First try direct asset loading with UPM package paths
