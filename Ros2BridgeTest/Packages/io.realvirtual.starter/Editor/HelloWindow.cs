...
namespace realvirtual
{
    ...
    public class HelloWindow : EditorWindow
    {
        ...
        [MenuItem("Tools/realvirtual/Info", false,999)]
        static void Init()
        {
        ...
        public void Open()
        {
            ...
            image = AssetDatabase.LoadAssetAtPath<Texture2D>(RealvirtualAssetPaths.StarterEditorAssets("Icons/hellowindow.png"));
