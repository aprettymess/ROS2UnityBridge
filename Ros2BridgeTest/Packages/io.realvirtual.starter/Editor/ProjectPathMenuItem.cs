...
namespace realvirtual
{
    ...
    {
        public const string MenuName = "Tools/realvirtual/Settings/Show Project Path in Toolbar";
...
#else
            // Unity 6+ uses MainToolbar API - force refresh
            UnityEditor.Toolbars.MainToolbar.Refresh("realvirtual Project Path");
