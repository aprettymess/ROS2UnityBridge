...
namespace RenderPipeLineSetup{
    ...
    public static class RenderPipelineTools
    {
        ...
        [MenuItem("Tools/realvirtual/Settings/Render Pipelines/Switch to Standard Render Pipeline (SRP)",false,912)]
        ...
        [MenuItem("Tools/realvirtual/Settings/Render Pipelines/Switch to Universal Render Pipeline (URP)", false, 913)]
        ...
        [MenuItem("Tools/realvirtual/Settings/Render Pipelines/Switch to HD render Pipeline (HDRP)/Path Tracing",false, 914)]
        public static void SwitchToHDRPPathTracing(){
            SwitchToHDRP(HDRPRenderMode.PathTracing);
        }

        [MenuItem("Tools/realvirtual/Settings/Render Pipelines/Switch to HD render Pipeline (HDRP)/Ray Tracing",false, 915)]
