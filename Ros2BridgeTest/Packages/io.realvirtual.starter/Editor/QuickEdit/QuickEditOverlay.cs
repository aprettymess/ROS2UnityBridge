...
namespace realvirtual
{
    ...
    public partial class QuickEditOverlay : Overlay
    {
        ...
        /// <summary>
        /// The main button container. Public for Professional extension access.
        /// </summary>
        ...
        public override VisualElement CreatePanelContent()
        {
            ...
            // Load the stylesheet from UPM package path
            var styleSheetPath = RealvirtualAssetPaths.StarterEditor("QuickEdit/QuickEdit.uss");
        ...
        {
            icon0local = AssetDatabase.LoadAssetAtPath<Texture>(RealvirtualAssetPaths.StarterEditorAssets("Icons/button-0local.png"));
            icon0global = AssetDatabase.LoadAssetAtPath<Texture>(RealvirtualAssetPaths.StarterEditorAssets("Icons/button-0global.png"));
            iconpivot = AssetDatabase.LoadAssetAtPath<Texture>(RealvirtualAssetPaths.StarterEditorAssets("Icons/button-pivot.png"));
            iconrotxplus = AssetDatabase.LoadAssetAtPath<Texture>(RealvirtualAssetPaths.StarterEditorAssets("Icons/button-xplus.png"));
            iconrotyplus = AssetDatabase.LoadAssetAtPath<Texture>(RealvirtualAssetPaths.StarterEditorAssets("Icons/button-yplus.png"));
            iconrotzplus = AssetDatabase.LoadAssetAtPath<Texture>(RealvirtualAssetPaths.StarterEditorAssets("Icons/button-zplus.png"));
            iconrotxminus = AssetDatabase.LoadAssetAtPath<Texture>(RealvirtualAssetPaths.StarterEditorAssets("Icons/button-xminus.png"));
            iconrotyminus = AssetDatabase.LoadAssetAtPath<Texture>(RealvirtualAssetPaths.StarterEditorAssets("Icons/button-yminus.png"));
            iconrotzminus = AssetDatabase.LoadAssetAtPath<Texture>(RealvirtualAssetPaths.StarterEditorAssets("Icons/button-zminus.png"));
            iconempty = AssetDatabase.LoadAssetAtPath<Texture>(RealvirtualAssetPaths.StarterEditorAssets("Icons/button-empty.png"));
            icontoempty = AssetDatabase.LoadAssetAtPath<Texture>(RealvirtualAssetPaths.StarterEditorAssets("Icons/button-toempty.png"));
            icondrive = AssetDatabase.LoadAssetAtPath<Texture>(RealvirtualAssetPaths.StarterEditorAssets("Icons/button-drive.png"));
            iconkinematic = AssetDatabase.LoadAssetAtPath<Texture>(RealvirtualAssetPaths.StarterEditorAssets("Icons/button-kinematic.png"));
            iconaxis = AssetDatabase.LoadAssetAtPath<Texture>(RealvirtualAssetPaths.StarterEditorAssets("Icons/button-axis.png"));
            iconinbool = AssetDatabase.LoadAssetAtPath<Texture>(RealvirtualAssetPaths.StarterEditorAssets("Icons/button-inputbool.png"));
            iconinfloat = AssetDatabase.LoadAssetAtPath<Texture>(RealvirtualAssetPaths.StarterEditorAssets("Icons/button-inputfloat.png"));
            iconinint = AssetDatabase.LoadAssetAtPath<Texture>(RealvirtualAssetPaths.StarterEditorAssets("Icons/button-inputint.png"));
            iconoutbool = AssetDatabase.LoadAssetAtPath<Texture>(RealvirtualAssetPaths.StarterEditorAssets("Icons/button-outputbool.png"));
            iconoutfloat = AssetDatabase.LoadAssetAtPath<Texture>(RealvirtualAssetPaths.StarterEditorAssets("Icons/button-outputfloat.png"));
            iconoutint = AssetDatabase.LoadAssetAtPath<Texture>(RealvirtualAssetPaths.StarterEditorAssets("Icons/button-outputint.png"));
            // Interface icon stays in Runtime/Resources as it's used by hierarchy display
        ...
        private void CreateComponentSection(QuickEditContext context)
        {
            ...
            // LogicStep buttons
            CreateLogicStepButtons(context);
        }

        #region LogicStep Buttons

        /// <summary>
        /// Determines if LogicStep buttons should be shown based on context.
        /// </summary>
        private bool ShouldShowLogicSteps(QuickEditContext context)
        {
            if (!context.HasSelection) return false;

            // Show if we're under a serial container OR if there's no LogicStep on current object
            return !context.HasLogicStep || context.IsUnderSerialContainer;
        }

        /// <summary>
        /// Creates LogicStep buttons in edit mode.
        /// </summary>
        private void CreateLogicStepButtons(QuickEditContext context)
        {
            ...
            if (serialContainer != null)
            {
                ...
                var logicRow5 = CreateButtonRow();
                logicRow5.Add(CreateTextButton("Pause", "Add Pause Step (Editor Breakpoint)", () => AddLogicStep(typeof(LogicStep_Pause))));
                logicContainer.Add(logicRow5);
            }
            else
            {
        ...
        /// <summary>
        /// Adds a LogicStep component to the selected GameObjects.
        /// </summary>
        ...
        #region LogicStep Visualization (Play Mode)

        /// <summary>
        /// Creates LogicStep visualization in play mode.
        /// </summary>
        private void CreateLogicStepVisualization()
        {
        ...
        private void CreateSignalSection(QuickEditContext context)
        {
            ...
            // Inject every OTHER registered section name (e.g. "Kinematics") - previously only the three
            // hardcoded names above were ever rendered, so a button registered with its own section name
            // was silently invisible despite the "Registered overlay button" log.
            foreach (var section in OverlayButtonRegistry.GetSectionsForOverlay(typeof(QuickEditOverlay)))
            {
                if (section == "Components" || section == "Signals" || section == "Custom")
                    continue;
                InjectCustomButtons(section);
            }
        }
        ...
        private void CreatePlayModeUI()
        {
            ...
            // LogicStep visualization in play mode
            CreateLogicStepVisualization();
        ...
        /// <summary>
        /// Adds a separator line to the button container. Public for Professional extension.
        /// </summary>
        ...
        /// <summary>
        /// Creates a button row container. Public for Professional extension.
        /// </summary>
        public VisualElement CreateButtonRow()
        {
        ...
        /// <summary>
        /// Creates a text button. Public for Professional extension.
        /// </summary>
        public Button CreateTextButton(string text, string tooltip, System.Action onClick, string buttonClass = null)
        {
            var button = new Button(onClick);
            button.text = text;
            button.tooltip = tooltip;
        ...
        /// <summary>
        /// Checks if GameObject has other realvirtual components. Public for Professional extension.
        /// </summary>
        public static bool HasOtherRealvirtualComponents(GameObject obj)
        {
